<?php
	...
	$timezone_list = array("Africa/Abidjan" => "Africa/Abidjan",
							...
							$dateformate_list = array(	"d-m-Y" => "dd-mm-yyyy",
														"Y-m-d" => "yyyy-mm-dd");
							$timeformate_list = array(	"H:i" => "hh:mm",
														"h:i A" => "hh:mm AM",
														"H:i:s" => "hh:mm:ss");
	...
	<div class="row">
		<div class="col-md-12">
			...
			<div class="panel panel-primary"><div class="panel-heading" >
					<?php echo $this->lang->line('change_timezone');?>
			</div>			
			<div class="panel-body" >
			<?php echo form_open('settings/save_timezone'); ?>
				<div class="col-md-3" >
					<div class="form-group" >
						<label for="timezones"><?php echo "Get Time Zone";?></label> 
						<?php echo form_dropdown('timezones', $timezone_list, $def_timezone,'class="form-control"'); ?>
					</div>
					<div class="form-group" >
						<button type="submit" name="submit" class="btn btn-primary" /><?php echo $this->lang->line('save');?></button>
					</div> 
			...
			<div class="panel panel-primary"><div class="panel-heading" >
					<?php echo "Change Time Formate";?>
			</div>
			<div class="panel-body" >
			<?php echo form_open('settings/save_time_formate'); ?>
				<div class="col-md-3" >
					<div class="form-group" >
						<label for="timeformate"><?php echo "Get Time Formate";?></label> 
						<?php echo form_dropdown('timeformate', $timeformate_list, $def_timeformate,'class="form-control"'); ?>
					</div>
					<div class="form-group" >
						<button type="submit" name="submit" class="btn btn-primary" /><?php echo $this->lang->line('save');?></button>
					</div> 
			...
			<div class="panel panel-primary"><div class="panel-heading" >
					<?php echo "Change Date Formate";?>
			</div>
			<div class="panel-body" >
			<?php echo form_open('settings/save_date_formate'); ?>
				<div class="col-md-3" >
					<div class="form-group" >
						<label for="timeformate"><?php echo "Get Date Formate";?></label> 
